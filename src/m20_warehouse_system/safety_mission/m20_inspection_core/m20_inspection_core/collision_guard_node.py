...
class CollisionGuard(Node):
    ...
    def __init__(self) -> None:
        ...
        self.declare_parameter('expected_cloud_frame', 'world')
        self.declare_parameter('occupancy_cloud_timeout_sec', 0.75)
        self.declare_parameter('online_grid_resolution', 0.10)
        self.declare_parameter('online_grid_size', 16.0)
        self.declare_parameter('minimum_obstacle_z_from_body', -0.50)
        self.declare_parameter('maximum_obstacle_z_from_body', 0.70)
        ...
        self._online_accepted_points = 0
        self._online_map_announced = False
    ...
    def _cloud_callback(self, message: PointCloud2) -> None:
        ...
        minimum_z = float(position.z) + float(
            self.get_parameter('minimum_obstacle_z_from_body').value
        )
        maximum_z = float(position.z) + float(
        ...
        if not self._online_map_announced:
