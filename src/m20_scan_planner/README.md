...
```bash
~/robodog_nav_system/src/m20_scan_planner/models/mockamap_single_floor/mockamap_single_floor.world
~/robodog_nav_system/src/m20_scan_planner/models/mockamap_single_floor/mockamap_single_floor.pcd
~/robodog_nav_system/src/m20_scan_planner/models/mockamap_single_floor/mockamap_single_floor.json
```
...
ros2 run m20_scan_planner generate_single_floor_gazebo_map.py \
  --output-dir src/m20_scan_planner/models/mockamap_single_floor \
  --seed 127 \
  --obstacle-count 180
...
```bash
~/robodog_nav_system/src/m20_scan_planner/models/1_Building/Building_surface_0p10.pcd
```
...
ros2 run m20_scan_planner traversability_global_planner.py \
  --no-ros \
  --pcd src/m20_scan_planner/models/1_Building/Building_surface_0p10.pcd \
  --start -5.0 7.0 0.59 \
  --goal 2.0 -3.0 4.4
```
...
ros2 run m20_scan_planner collada_mesh_to_pcd.py \
  src/m20_scan_planner/models/1_Building/Building.dae \
  src/m20_scan_planner/models/1_Building/Building_surface_0p10.pcd \
  --spacing 0.08 \
  --voxel-size 0.10 \
  --translation 0 0 -0.1
```
