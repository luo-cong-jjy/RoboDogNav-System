# ============================================================================
# 文件：factory_inspection_mission_gazebo.launch.py
# 功能：启动 Gazebo 专用 M20 工厂巡检任务节点。
#       该节点读取 Gazebo 巡检途经点参数文件，
...
def generate_launch_description():
    ...
    default_params = str(pkg_share / "config" / "factory_inspection_midpoints_gazebo.yaml")
    ...
    return LaunchDescription([
        ...
        # Gazebo publishes /clock; keep this entry point on simulation time.
        DeclareLaunchArgument("use_sim_time", default_value="true"),

        Node(  # 启动工厂巡检任务节点
            package="m20_nav2_system",  # 所属功能包
            executable="factory_inspection_nav2_mission_gazebo",
            name="factory_inspection_nav2_mission_gazebo",
